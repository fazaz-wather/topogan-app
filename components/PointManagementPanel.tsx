...
const PointManagementPanel: React.FC<PointManagementPanelProps> = ({
    ...
    return (
        <div className={`bg-white dark:bg-gray-800 rounded-lg shadow-md border border-gray-200 dark:border-gray-700 flex flex-col h-full ${compact ? 'p-3 space-y-3' : 'p-4 space-y-4'}`}>
            <div className="flex justify-between items-center flex-shrink-0">
                <h3 className="text-lg font-bold">Données de la Parcelle</h3>
                ...
                <div className="grid grid-cols-2 gap-2">
                 ...
                 {showExports && points.length > 0 && (
                    <div className="border-t border-gray-200 dark:border-gray-700 pt-4 space-y-4">
                        <h3 className="text-md font-semibold">Exports & Rapports</h3>
                        
                        {onOpenBornageSketch && (
                            <button
                                onClick={onOpenBornageSketch}
                                disabled={points.length === 0}
                                className="w-full bg-indigo-600 text-white font-bold py-2 px-4 rounded-md hover:bg-indigo-700 disabled:bg-gray-400 dark:disabled:bg-gray-600 disabled:cursor-not-allowed transition duration-200 flex items-center justify-center space-x-2"
                            >
                                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                                    <path d="M17.414 2.586a2 2 0 00-2.828 0L7 10.172V13h2.828l7.586-7.586a2 2 0 000-2.828z" />
                                    <path fillRule="evenodd" d="M2 6a2 2 0 012-2h4a1 1 0 010 2H4v10h10v-4a1 1 0 112 0v4a2 2 0 01-2 2H4a2 2 0 01-2-2V6z" clipRule="evenodd" />
                                </svg>
                                <span>Afficher le Croquis de Bornage</span>
                            </button>
                        )}
