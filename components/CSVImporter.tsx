...
const CSVImporter: React.FC<CSVImporterProps> = ({ onImport, setNotification }) => {
  ...
  return (
    <div>
      ...
      <button
        onClick={handleClick}
        className="w-full bg-gray-600 text-white font-semibold py-2 px-4 rounded-md hover:bg-gray-700 transition duration-200 flex items-center justify-center space-x-2"
      >
